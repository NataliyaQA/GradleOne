...
public class CarrouselBannerTest {
    public static class carrouselSelection extends AbstractClass {

        @Test //re-wrote  + question (why we return to the initial page and make there verification, why don't do it on redirection page?)
